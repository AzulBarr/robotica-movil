...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/src/robotica/install/modelo_diferencial"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/modelo_diferencial/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/modelo_diferencial/environment/path.sh"
