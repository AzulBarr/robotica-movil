...
// void robmovil_ekf::Localizer::on_imu(const sensor_msgs::msg::Imu::SharedPtr msg) /// No hay imu
// {
//   u(2) = msg->angular_velocity.z;
//   RCLCPP_INFO(this->get_logger(), "Received angular velocity Z: %f", u(2));
// }
...
void robmovil_ekf::Localizer::on_odometry(const nav_msgs::msg::Odometry::SharedPtr msg)
{
  ...
  u(3) = msg->twist.twist.linear.y;
  RCLCPP_INFO(this->get_logger(), "Received linear velocity X: %f", u(1));
  RCLCPP_INFO(this->get_logger(), "Received linear velocity Y: %f", u(3));
  RCLCPP_INFO(this->get_logger(), "Received linear angular Z: %f", u(2));
}
