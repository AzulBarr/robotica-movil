...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/src/robotica/install/lazo_cerrado"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lazo_cerrado/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lazo_cerrado/environment/path.sh"
